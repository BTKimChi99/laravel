...
@section('title', 'Experience_points')
@section('content')
@section('css')
<link rel="stylesheet" href="{{ asset('css/pages/experience_point.css')}}">
<link rel="stylesheet" href="{{ asset('css/pages/common.css')}}">
@endsection
@include('frontend\common')
    <div class="page-content" id="experience_points">
        ...
        <div class="img-btn col-12">
            <a href="{{ route('result')}}" class="btn common-btn blue-color">
                <span>フィニッシュ</span>
